export default {
  ...
  aboutTitle1: 'How',
  aboutTitle2: 'I work',
  aboutP1: 'A developer by background, I came to infrastructure through my assignments, on Linux: Ubuntu on my workstation for one, a Debian derivative for the other, with package creation and fixes.',
  ...
  cvProfileP2: 'I am looking for a context where those practices belong to the team: bringing my expertise to it, and keeping up my progress on those subjects and on applied AI (LLMs, agents, MCP).',
  cvStackLabel: 'Stack',
