export default {
  // Site
  siteTitle: 'xgueret',
  homeTitle: 'Xavier Gueret — DevOps Engineer in Guadeloupe',
  siteDescription: 'Xavier Gueret, DevOps Engineer based in Guadeloupe. Kubernetes, Terraform, Python and applied AI (LLM, MCP): technical articles, tutorials and field notes on automation and cloud-native systems.',
  ...
  aboutTitle1: 'How',
  aboutTitle2: 'I work',
  aboutP1: 'A developer by background, I came to infrastructure through assignments on corporate Linux desktops: Ubuntu and an in-house Debian derivative, along with building and fixing the packages that go with them.',
  aboutP2: 'From there I moved to automation, containers and deployment: Ansible and Puppet, then OpenShift, Docker, Podman and Kubernetes. I have kept going deeper since, and I write infrastructure as code, versioned and replayed identically.',
  aboutP3: 'My homelab is my proving ground: whatever ends up in production, I have broken and rebuilt at home first. That is where I work out the provisioning and deployment chains.',
  ...
  blogTitle2: 'rebuild,',
  blogTitle3: 'learn,',
  blogTitle4: 'experiment.',
  blogIntro: 'Kubernetes, Terraform, Ansible, homelab, applied AI… The subjects I dig into here, in long-form articles, use cases and step-by-step tutorials.',
  blogHomeTitle1: 'What I\'m writing',
  blogHomeTitle2: 'right now',
