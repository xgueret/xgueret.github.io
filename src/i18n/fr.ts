export default {
  ...
  aboutTitle1: 'Du code',
  aboutTitle2: 'à l\'infra',
  aboutP1: 'D\'abord développeur, j\'ai progressivement évolué vers l\'automatisation, l\'Infrastructure as Code et l\'environnement Linux au fil de mes missions. Lors des deux dernières, en ESN, je travaillais sur un poste sous Ubuntu pour l\'une et sous une distribution dérivée de Debian pour l\'autre, avec des tâches de création et de correction de paquets.',
  ...
  cvProfileP2: 'Je cherche un contexte où ces pratiques sont portées par l\'équipe : y apporter mon expertise, et continuer à progresser sur ces sujets comme sur l\'IA appliquée (LLM, agents, MCP).',
  cvStackLabel: 'Stack',
